...
const categoryName = "Laundry Bin";
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-2 text-sm mt-1">
                      <span className="font-semibold text-gray-900 text-xl">₹{product.sellingPrice.toLocaleString()}</span>
                      <span className="line-through text-gray-500">₹{product.actualPrice.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </Zoom>
