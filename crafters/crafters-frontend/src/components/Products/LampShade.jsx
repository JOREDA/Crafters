                  ...
                  <div className="relative w-full h-64 overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = `https://placehold.co/400x400/788c7c/FFFFFF/png?text=${encodeURIComponent(product.name)}`;
                      }}
                    />
